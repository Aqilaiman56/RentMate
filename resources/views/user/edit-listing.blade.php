            ...
            <div class="form-section">
                ...
                @if($item->images->count() > 0)
                    <div class="current-images">
                        <span class="current-images-label">Current Images ({{ $item->images->count() }})</span>
                            ...
                            @foreach($item->images as $index => $image)
                                <div class="current-image-item">
                                    <img src="{{ asset('storage/' . $image->ImagePath) }}"
                                         ...
                                         onerror="this.src='https://via.placeholder.com/300x200/4461F2/fff?text=Image+{{ $index + 1 }}'">
                                    <div class="current-image-number">Image {{ $index + 1 }}</div>
                                </div>
                            @endforeach
                        </div>
                    </div>
                @else
                    <div class="alert alert-info" style="margin-bottom: 20px;">
                        <p>No images uploaded yet. Please upload 1-4 images below.</p>
                    </div>
                @endif

                <div class="form-group">
                    <label class="form-label">
                        Upload New Images (1-4 images, Optional)
                    </label>
                    ...
                    <div class="form-help">Leave empty to keep current images. Uploading new images will replace all existing images.</div>
                    @error('images')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                    @error('images.*')
            ...
            selectedFiles.forEach((file, index) => {
                ...
                reader.onload = function(e) {
                    ...
                    div.innerHTML = `
                        ...
                        <div class="image-number">New Image ${index + 1}</div>
                    `;
