        ...
        <div class="footer-top">
            ...
            <div class="footer-column">
                ...
                <p class="footer-description">
                    Rent anything, anytime. Connect with your community and make the most of shared resources.
                </p>
            ...
            <div class="footer-column">
                ...
                <ul class="footer-links">
                    <li><a href="{{ route('user.HomePage') }}">Browse Items</a></li>
                    <li><a href="{{ route('user.add-listing') }}">List an Item</a></li>
                    <li><a href="{{ route('user.listings') }}">My Listings</a></li>
