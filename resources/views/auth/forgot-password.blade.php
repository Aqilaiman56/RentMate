        ...
        <div class="gorent-right-section">
            <div class="gorent-login-card">
                <div class="gorent-form-header">
                    ...
                    <p class="gorent-subtitle">No problem. Enter your email address and we'll send you a password reset link.</p>
                </div>

                <!-- Session Status -->
                <x-auth-session-status class="gorent-status-message" :status="session('status')" />

                <form method="POST" action="{{ route('password.email') }}" class="gorent-form">
                    @csrf
                    ...
                    <!-- Back to Login -->
                    <div class="gorent-back-section">
                        <a href="{{ route('login') }}" class="gorent-back-link">
